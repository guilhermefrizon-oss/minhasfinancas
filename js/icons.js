...
const ICONS = {
  ...
  'Globoplay':       brandImg('tvglobo',       'F5423C'),
  'Disney+':         brandImg('disneyplus',   '113CCF'),
  'HBO Max':         brandImg('max',          '002BE7'),
  ...
  'Inter':           brandImg('bancointer',   'FF7A00'),
